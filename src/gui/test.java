	...
	static {
		if (System.getProperty("os.name").contains("Windows")) {
			if (System.getenv("ProgramFiles(x86)") != null) {
				System.out.print("64bit");
				System.loadLibrary("opencv_java320_x64");
			} else {
				System.out.print("86bit");
				System.loadLibrary("opencv_java320_x86");
			}
		} else {
			System.out.print("This program cannot be used at Linux!");
			System.exit(0);
		}
	}
	JFrame jFrame;
	...
	public void playVideo() {
		...
		while (true) {
			if (!camera.read(inFrame))
				break;
			Imgproc.resize(inFrame, inFrame, new Size(CONFIG.FRAME_WIDTH, CONFIG.FRAME_HEIGHT), 0., 0.,
			...
			if (i == 1) {
				...
				Imgproc.putText(imag, "Input: " + CONFIG.filename, new Point(20, 360), Core.FONT_HERSHEY_PLAIN, 1,
						new Scalar(255, 255, 255), 1);
				Imgproc.putText(imag,
						"So track hien tai: " + tracker.tracks.size() + "     Da xoa: " + tracker.track_removed,
						new Point(20, 50), Core.FONT_HERSHEY_PLAIN, 1, new Scalar(255, 255, 255), 1);
			}
